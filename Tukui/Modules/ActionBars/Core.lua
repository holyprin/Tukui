...
function TukuiActionBars:AddPanels()
	...
	A1:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, Size + Spacing + 14)
	...
	A2:Point("BOTTOMRIGHT", A1, "BOTTOMLEFT", -6, -(Size + Spacing))
	...
	A3:Point("BOTTOMLEFT", A1, "BOTTOMRIGHT", 6, -(Size + Spacing))
